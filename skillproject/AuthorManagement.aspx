<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AuthorManagement.aspx.cs" Inherits="skillproject.AuthorManagement" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100" src="imgs/writer.png" alt="" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredAuthorID" runat="server" ErrorMessage="Author ID Required!" ControlToValidate="TextBox1" ForeColor="#990000" Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredAuthorName" runat="server" ErrorMessage="Author Name Required!" ControlToValidate="TextBox2" ForeColor="#990000" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString2 %>" SelectCommand="SELECT * FROM [AuthorDetails]"></asp:SqlDataSource>
